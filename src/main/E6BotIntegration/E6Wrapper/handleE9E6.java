...
public class handleE9E6 {
    ...
    public static String handleE6(String type, String customType) throws IOException {
        if (type.equals("custom")){
            return new main.E6BotIntegration.E6Wrapper.HTTPRequestHandler().getPost(customType, true);
        }
        return new main.E6BotIntegration.E6Wrapper.HTTPRequestHandler().getPost(type, true);
    }
    public static String handleE9(String type, String customTags) throws IOException {
        if (type.equals("custom")){
            return new main.E6BotIntegration.E6Wrapper.HTTPRequestHandler().getPost(customTags, false);
        }
        return new main.E6BotIntegration.E6Wrapper.HTTPRequestHandler().getPost(type, false);
    }
}
