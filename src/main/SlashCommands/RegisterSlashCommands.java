...
public class RegisterSlashCommands extends ListenerAdapter {
    ...
    public void onGuildReady(GuildReadyEvent event) {
        ...
        OptionData ticketOptions = new OptionData(OptionType.STRING, "ticket-type", "Die Art des Tickets", true).addChoice("Support", "support").addChoice("Nsfw-Freischaltung", "nsfw-freischaltung").addChoice("Vorschlag", "vorschlag");
